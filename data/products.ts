...
export const products: Product[] = [
    ...
    },
    {
        ...
        category: '기업용 드론',
        description: '열화상 기능을 갖춘 소방·수색·야간 작업용 드론',
        detailDescription: 'Mavic 3 Thermal은 소형 상업용 드론에 열화상 기능을 결합한 특수 작업용 드론입니다. 640×512 픽셀 열화상 카메라, 기계식 셔터를 갖춘 4/3 CMOS 카메라, 56배 하이브리드 줌을 탑재하여 소방, 수색 구조, 점검, 야간 작업 등 다양한 임무를 수행할 수 있습니다. RTK 모듈과 DJI O3 Enterprise 전송 시스템, 고음량 스피커를 갖춘 완벽한 공공 안전 및 점검 솔루션입니다.',
        price: 7520100,
        ...
        featured: false,
        tags: ['열화상', 'RTK', '점검', 'Mavic', '소방', '수색구조', '야간작업', '공공안전'],
        ...
        features: [
            ...
            '기계식 셔터로 왜곡 없는 이미지',
            '56배 하이브리드 줌',
            'RTK 모듈 지원으로 센티미터급 정밀도',
            '최대 45분 비행시간',
            'DJI O3 Enterprise 전송 시스템',
            '고음량 스피커 탑재'
        ],
        specifications: [
            ...
            { label: '최대 전송거리', value: '15km (FCC)' },
            { label: '열화상 카메라', value: '640×512, 30Hz' },
            { label: '광각 카메라', value: '4/3 CMOS, 20MP' },
            { label: '셔터', value: '기계식 셔터' },
            { label: '렌즈', value: '24mm, f/2.8-f/11' },
            { label: '줌', value: '56배 하이브리드 줌' },
            { label: 'RTK', value: '수평: 1cm+1ppm, 수직: 1.5cm+1ppm' },
            { label: '전송 시스템', value: 'DJI O3 Enterprise' },
            { label: '작동 온도', value: '-20°C ~ 50°C' }
        ]
    },
    {
        ...
        category: '기업용 드론',
        description: '산업용 촬영 및 점검에 최적화된 컴팩트한 상업용 드론',
        detailDescription: 'Mavic 3 Enterprise Series는 소형 상업용 드론의 산업 표준을 재정의합니다. 기계식 셔터, 56배 줌 카메라, 센티미터급 정밀도의 RTK 모듈을 갖춘 Mavic 3E는 매핑 및 임무 효율성을 새로운 차원으로 끌어올립니다. DJI O3 Enterprise 전송 시스템과 고음량 스피커를 탑재하여 다양한 산업 현장에서 활용 가능합니다.',
        price: 5513800,
